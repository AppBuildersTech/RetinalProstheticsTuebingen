...
% exp_dict('2016_09_08_R1') = {'adch_21e','adch_22b','adch_75d'};
% exp_dict('2016_09_08_L1') = {'adch_75d'}; % last trial is 27 then 54. what is happening?

%exp_dict('2017_03_07_L1') = {'adch_34c','adch_46b'};
%exp_dict('2017_03_07_R1') = {'adch_48g'};

%exp_dict('2017_03_16_R1') = {'adch_36b'};%not working

%exp_dict('2017_03_21') = {'adch_56g','adch_67e'};%not working
%exp_dict('2017_04_12') = {'adch_52b'};%not existing
